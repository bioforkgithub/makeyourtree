...
Parts of the source code, the test suite and the documentation were written with the
assistance of a large language model (Anthropic Claude), used as a tool under the
direction of the author, who specified the architecture, reviewed the code and is
responsible for the whole of the software.

Every number quoted in the documentation was produced by running the program, not
generated by a language model. No artificial intelligence system is an author or a
